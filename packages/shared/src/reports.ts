...
const EN: LabelBundle = {
  ...
  'action.announcement.created': 'Announcement drafted',
  'action.announcement.updated': 'Announcement draft changed',
  'action.announcement.published': 'Announcement published',
  'action.announcement.sent': 'Announcement sent by SMS',
  'action.sms.sent': 'Messages sent to members',
  'action.announcement.archived': 'Announcement withdrawn',
...
const RW: LabelBundle = {
  ...
  'action.announcement.created': "Itangazo ryanditswe nk'umushinga",
  'action.announcement.updated': "Umushinga w'itangazo wahinduwe",
  'action.announcement.published': 'Itangazo ryatangajwe',
  'action.announcement.sent': 'Itangazo ryoherejwe kuri SMS',
  'action.sms.sent': 'Ubutumwa bwoherejwe ku banyamuryango',
  'action.announcement.archived': 'Itangazo ryakuweho',
