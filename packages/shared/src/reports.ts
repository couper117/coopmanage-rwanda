...
export const REPORTS: Readonly<Record<ReportType, ReportDefinition>> = {
  ...
  meeting: {
    ...
    sectionPermissions: {},
    // Meetings arrive in Phase 9. The report is listed and refuses with its phase rather than
    // being hidden, because a cooperative that expects a minutes report should be told when it
    // comes rather than left to wonder whether they have the wrong menu.
    available: false,
