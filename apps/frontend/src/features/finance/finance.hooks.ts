...
// The bar geometry moved to `lib/chartGeometry.ts` when the dashboard needed it too, and is
// re-exported here so the finance screens' imports read as they always did.
export { barPercent, isZeroAmount, largestMinorUnits, toMinorUnits } from '@/lib/chartGeometry'
